...
class CollegePosts extends StatefulWidget {
  const CollegePosts({super.key});

  @override
  State<CollegePosts> createState() => _CollegePosts();
}

class _CollegePosts extends State<CollegePosts> {
                    ...
                    Container(
                      ...
                      child: StreamBuilder<QuerySnapshot>(
                        stream: escalate.firebaseFirestore!
                            .collection("posts")
                            .where("postedFor", isEqualTo: "College")
