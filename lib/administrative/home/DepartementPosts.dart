...
class DepartementPostsAdmnistrative extends StatefulWidget {
  const DepartementPostsAdmnistrative({super.key});

  @override
  State<DepartementPostsAdmnistrative> createState() =>
      _DepartementPostsAdmnistrative();
}

class _DepartementPostsAdmnistrative
    extends State<DepartementPostsAdmnistrative> {
  var fullName =
