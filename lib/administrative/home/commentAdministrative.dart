...
class CommentsPageAdmnistrative extends StatefulWidget {
  final String PostUid;
  const CommentsPageAdmnistrative({super.key, required this.PostUid});

  @override
  State<CommentsPageAdmnistrative> createState() =>
      _CommentsPageAdmnistrative();
}

class _CommentsPageAdmnistrative extends State<CommentsPageAdmnistrative> {
  var fullName =
