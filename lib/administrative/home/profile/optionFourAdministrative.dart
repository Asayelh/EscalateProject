...
class OptionFourAdminstative extends StatefulWidget {
  const OptionFourAdminstative({super.key});

  @override
  State<OptionFourAdminstative> createState() => _OptionFourAdminstative();
}

class _OptionFourAdminstative extends State<OptionFourAdminstative> {
            ...
            children: [
              ...
              StreamBuilder<QuerySnapshot>(
                stream: escalate.firebaseFirestore!
                    ...
                    .where("postStatus", isEqualTo: "solved")
                    .snapshots(),
