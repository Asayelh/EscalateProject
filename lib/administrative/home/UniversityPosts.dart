...
import 'package:esclate/administrative/home/commentAdministrative.dart';
...
class UniversityPostsAdministrative extends StatefulWidget {
  const UniversityPostsAdministrative({super.key});

  @override
  State<UniversityPostsAdministrative> createState() =>
      _UniversityPostsAdministrative();
}

class _UniversityPostsAdministrative
    extends State<UniversityPostsAdministrative> {
  var fullName =
      escalate.sharedPreferences!.getString(escalate.AdministrativeName);

  var Sector =
      escalate.sharedPreferences!.getString(escalate.AdministrativeSecotr);

  var Email =
      escalate.sharedPreferences!.getString(escalate.AdministrativeEmail);
  var Depratment =
      escalate.sharedPreferences!.getString(escalate.AdministrativeDepartemnt);
                    ...
                    Container(
                      ...
                      child: StreamBuilder<QuerySnapshot>(
                        stream: escalate.firebaseFirestore!
                            .collection("posts")
                            .where("postedFor", isEqualTo: "University")
  ...
  savingPost() async {
    ...
    escalate.firebaseFirestore!.collection("posts").add({
      ...
      Route route =
          MaterialPageRoute(builder: (_) => const BottomNavAdminstrative());
